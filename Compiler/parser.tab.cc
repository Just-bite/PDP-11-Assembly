...
#line 141 "parser.yy"
                          {std::cout << "comment : "<<yystack_[1].value.as < std::string > () <<std::endl;}
...
#line 747 "parser.tab.cc"
  ...
  case 8: // expr: "instruction" adressingS "," adressingD
#line 145 "parser.yy"
                                                {
            add_instruction(yystack_[3].value.as < std::string > (),{yystack_[2].value.as < Operand > (),yystack_[0].value.as < Operand > ()},drv);
        }
#line 755 "parser.tab.cc"
    break;

  case 9: // expr: "instruction" adressingD
#line 149 "parser.yy"
                               { 
            add_instruction(yystack_[1].value.as < std::string > (),{yystack_[0].value.as < Operand > ()},drv);
        }
#line 763 "parser.tab.cc"
    break;

  case 10: // expr: "instruction"
#line 153 "parser.yy"
                    {
            add_instruction(yystack_[0].value.as < std::string > (), {},drv);
        }
#line 771 "parser.tab.cc"
    break;

  case 11: // expr: "label" expr
#line 157 "parser.yy"
                   {
            process_label(yystack_[1].value.as < std::string > (),drv);
        }
#line 779 "parser.tab.cc"
    break;

  case 12: // expr: "branch" "label"
#line 161 "parser.yy"
                     {
            add_instruction(yystack_[1].value.as < std::string > (),{Operand(0,RELATIVE)},drv);
            process_label(yystack_[0].value.as < std::string > (),drv);
        }
...
#line 796 "parser.tab.cc"
  ...
  case 14: // adressingS: "register"
#line 171 "parser.yy"
                 {
            yylhs.value.as < Operand > () = Operand(atoi(yystack_[0].value.as < std::string > ().substr(1).c_str()), REG);
            current_addressing_flags &=REG;
        }
#line 805 "parser.tab.cc"
    break;

  case 15: // adressingS: prereg "register" postreg
#line 176 "parser.yy"
                                {
            yylhs.value.as < Operand > () = Operand(atoi(yystack_[1].value.as < std::string > ().substr(1).c_str()),determine_adressing_type(),yystack_[2].value.as < int16_t > ());
            current_addressing_flags &=REG;
        }
#line 814 "parser.tab.cc"
    break;

  case 16: // adressingS: notreg
#line 181 "parser.yy"
               {
            yylhs.value.as < Operand > () = Operand(-1,determine_adressing_type(),yystack_[0].value.as < int16_t > ());    
            current_addressing_flags &=REG;
        }
#line 823 "parser.tab.cc"
    break;

  case 17: // adressingD: "register"
#line 187 "parser.yy"
                 {
            yylhs.value.as < Operand > () = Operand(atoi(yystack_[0].value.as < std::string > ().substr(1).c_str()), REG);
            current_addressing_flags &=REG;
...
#line 832 "parser.tab.cc"
  ...
  case 18: // adressingD: prereg "register" postreg
#line 192 "parser.yy"
                                {
            yylhs.value.as < Operand > () = Operand(atoi(yystack_[1].value.as < std::string > ().substr(1).c_str()),determine_adressing_type(),yystack_[2].value.as < int16_t > ());
            current_addressing_flags &=REG;
...
#line 850 "parser.tab.cc"
  ...
  case 20: // notreg: "at" "numsign" number
#line 204 "parser.yy"
                          { 
...
#line 956 "parser.tab.cc"
  ...
  "newline", "branch", "register", "label", "directive", "at", "numsign",
  "lparen", "rparen", "minus", "plus", "hexnum", "octnum", "decnum",
  "$accept", "program1", "input", "line", "expr", "adressingS",
  "adressingD", "notreg", "number", "prereg", "postreg", "prelp", YY_NULLPTR
    };
...
#undef YYCASE_
  ...
  parser::yypact_[] =
  {
     -13,     8,    28,   -13,   -13,    -6,   -13,     1,    12,   -13,
      -2,    11,    21,    29,   -13,   -13,   -13,   -13,   -13,    20,
     -13,   -13,   -13,    22,    16,   -13,   -13,    25,   -13,    29,
     -13,   -13,   -13,     7,    35,   -13,   -13,   -13,   -13,    26,
     -13,    34,    36,    47,    35,   -13,   -13
  };

  const signed char
  parser::yydefact_[] =
  {
       3,     0,     0,     1,     2,    10,     7,     0,    13,     4,
       0,    17,    30,     0,    24,    31,    21,    22,    23,     0,
       9,    16,    32,     0,     0,    12,    11,     0,     5,     0,
      28,    29,    19,     0,     0,    25,     6,    20,    17,    30,
       8,     0,    26,    18,     0,    27,    18
  };
  ...
  parser::yytable_[] =
  {
      31,    32,    11,    27,    28,    12,    13,    14,     3,    15,
      25,    16,    17,    18,   -14,    38,     5,    37,    39,     7,
      14,     8,    15,    33,    16,    17,    18,    31,     4,    35,
      34,    36,     5,    29,     6,     7,    30,     8,    16,    17,
      18,    30,    44,    16,    17,    18,    16,    17,    18,    42,
     -15,    26,    45,    46,     0,     0,    40,    41
  };

  const signed char
  parser::yycheck_[] =
  {
      12,    13,     8,     5,     6,    11,    12,    13,     0,    15,
       9,    17,    18,    19,     3,     8,     4,    29,    11,     7,
      13,     9,    15,     3,    17,    18,    19,    39,     0,    13,
       8,     6,     4,    12,     6,     7,    15,     9,    17,    18,
      19,    15,     8,    17,    18,    19,    17,    18,    19,    14,
       3,     8,    16,    44,    -1,    -1,    33,    33
  };
  ...
  parser::yystos_[] =
  {
       0,    21,    22,     0,     0,     4,     6,     7,     9,    23,
      24,     8,    11,    12,    13,    15,    17,    18,    19,    25,
      26,    27,    28,    29,    31,     9,    24,     5,     6,    12,
      15,    28,    28,     3,     8,    13,     6,    28,     8,    11,
      26,    29,    14,    30,     8,    16,    30
  };
  ...
  parser::yyrline_[] =
  {
       0,   129,   129,   136,   137,   140,   141,   142,   145,   149,
     153,   157,   161,   166,   171,   176,   181,   187,   192,   199,
     204,   210,   211,   212,   216,   219,   225,   228,   233,   237,
     242,   246,   250
  };
